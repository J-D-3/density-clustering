...
def main():
    ...
    labels = optics_py.cluster_dbscan(pts, min_pts=8, threshold=5.0, min_cluster_frac=0.05)
    ...
    for dim in (1, 3, 4):
        ...
        out = optics_py.cluster_dbscan(p, min_pts=5, threshold=5.0)
        assert out.shape == (60,)

    print(f"optics_py OK: cluster_dbscan -> {n_clusters} clusters; reachability + xi + 1/3/4-D dispatch pass")
